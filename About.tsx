    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-6">
      <div className="max-w-4xl bg-white shadow-lg rounded-2xl p-8">
        ...
        <p className="text-lg text-gray-700 text-center mb-8">
          <strong>[Your App Name]</strong> is the go-to platform for finding and offering local services. Whether you're a skilled professional, a small business owner, or someone looking for trusted help, we connect you with the right people in your community.
        </p>
